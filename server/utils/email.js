...
const sendEmail = async ({ to, subject, html }) => {
  ...
  const data = JSON.stringify({
    sender: { name: 'Vignesh Konda Bike Rentals', email: 'vinodchintu70@gmail.com' },
    to: [{ email: to }],
    subject,
    htmlContent: html,
  })
...
exports.sendBookingRequestToOwner = async (data) => {
  ...
  await sendEmail({
    ...
    html: `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0F1115;color:#fff;border-radius:16px;overflow:hidden;">
      ...
      <div style="padding:32px;">
        ...
        <div style="background:#1A1D24;border:1px solid #2A2D35;border-radius:12px;padding:24px;margin-bottom:20px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            <tr><td style="color:#9CA3AF;padding:6px 0;width:40%;">Bike Name</td><td style="color:#fff;font-weight:600;">${bikeName}</td></tr>
        ...
        <div style="background:#1A1D24;border:1px solid #2A2D35;border-radius:12px;padding:24px;margin-bottom:20px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            <tr><td style="color:#9CA3AF;padding:6px 0;width:40%;">Name</td><td style="color:#fff;font-weight:600;">${customerName}</td></tr>
        ...
        <div style="background:#1A1D24;border:1px solid #2A2D35;border-radius:12px;padding:24px;margin-bottom:20px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            <tr><td style="color:#9CA3AF;padding:6px 0;width:40%;">Pickup Date</td><td style="color:#fff;font-weight:600;">${pickup}</td></tr>
        ...
        <p style="color:#9CA3AF;font-size:14px;text-align:center;">Login to your owner dashboard to approve or reject this booking.</p>
      </div>
    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0F1115;color:#fff;border-radius:16px;overflow:hidden;">
      ...
      <div style="padding:32px;">
        <div style="background:#1A1D24;border:1px solid #2A2D35;border-radius:12px;padding:24px;margin-bottom:20px;">
          ...
          <table style="width:100%;border-collapse:collapse;">
            <tr><td style="color:#9CA3AF;padding:6px 0;width:40%;">Bike</td><td style="color:#fff;font-weight:600;">${booking.bike?.name}</td></tr>
        ...
        <div style="background:#1A1D24;border-radius:12px;padding:16px;">
...
exports.sendPasswordResetEmail = async (email, resetUrl) => {
  await sendEmail({
    ...
    html: `
    <div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;background:#0F1115;color:#fff;padding:40px;border-radius:16px;">
